        ...
        child: Center(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  r'La contraseña debe tener al menos seis caracteres e incluir una combinación de números, letras y caracteres especiales (!@#$&*~), al menos 2 caracteres especiales.',
                  style: TextStyle(
                    fontSize: 16,
                  ),
                ),
